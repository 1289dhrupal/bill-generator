...
<nav id="sidebarMenu" class="col-2 col-md-3 col-lg-2 bg-light p-0 vh-100">
    <div class="d-flex flex-column p-3 bg-dark col-2 col-md-3 col-lg-2 d-md-block h-100 position-fixed">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <svg class="bi me-2" width="40" height="32">
                <use xlink:href="#bootstrap"></use>
            </svg>
            <span class="d-md-inline d-none">
                <span class="fs-4"><?php echo DEFAULT_TITLE ?></span>
            </span>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <!-- <li class="nav-item">
                <a href="<?php echo BASE_URL ?>" class="nav-link <?php echo $title == "Home" ? "active" : "text-white" ?> text-center text-md-start" aria-current="page">
            ...
            <li>
                <a href="<?php echo BASE_URL . "/uploadCSV.php" ?>" class="nav-link <?php echo $title == "uploadCSV" ? "active" : "text-white" ?> text-center text-md-start">
                    <svg class="bi me-2" width="16" height="16">
